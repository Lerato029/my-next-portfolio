        ...
        <>
            ...
            <div className="row  row-cols-1 row-cols-md-2  m-2">
                ...
                <div className="col-md-9">
                    <p className="pr-2 fs-5 mt-3 maxWidthTxt">
                        Hi, my name is Lerato Mokgwabona. I'm an entry level
                        Full-Stack Web Developer mostly interesting in the
                        client logic of applications. I enjoy solving problems,
                        coding, design and art. I come from an Architectural
                        background however, have been fascinated by the tech
                        industry, the virtual platforms created to improve the
                        way we live in reality. I love the freedom to create
                        anything I can think of. So I took the opportunity to
                        learn the skills to become a participant in the
                        industry. I look forward to working along side other
                        developers, UX and UI designers to create platforms that
                        provide the best experience for the users and be a part
                        of the community of developers who create platforms that
                        connect people. See how to contact me{' '}
                        <Link href="/contact">
                            <a
                                className="fw-bold "
                                style={{ color: '#c81e2a' }}
                ...
                {projectTags.map((details) => (
                    <div key={details.name} className="col mx-0 gx-0 px14">
                        <div
                            ...
                            onClick={() =>
                                handleContent(details.about, details.bg)
                            }
                            style={{
            ...
            <div className="landing">
                ...
                <Link href="/contact">
                    <button
                        type="button"
                        className="btn btn-success fw-bold my-5"
                    >
                        Contact Me
                    </button>
                </Link>
