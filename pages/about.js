  ...
  return (
    <div>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>More About My Background...</h1>
        ...
        <div className={styles.grid}>
          <div className={styles.card}>
            ...
            <p>
              ...
              applications. Below is a collection of languages, frameworks, and
              skills I've aquired in my journey thus far.
            </p>
